    ...
    <div v-show="showFlag" class="food" ref="foodScroll">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <ratingselect @select="selectRatingType" @toggle="contentToggle" :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings"></ratingselect>
...
export default {
  ...
  methods: {
    ...
    contentToggle() {
      ...
      this.$nextTick(() => {
        this.scroll.refresh();//页面重绘，重新计算高度
      });
    }
  },
  filters: {
