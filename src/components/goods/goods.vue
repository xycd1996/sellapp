<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" class="menu-item" :class="{'current':currentIndex===index}" @click="seletMenu(index)">
    ...
    created() {
      ...
      this.axios.get('/api/goods')
        .then((res) => {
          ...
          this.$nextTick(() => {
            this._initScroll()
            this._calculateHeight() // 必须放置此处，此处可以第一时间获取传进来的数据，从而进行dom操作
          })
        })
    },
    computed: {
